...
function buildMergeAndFilterSystemPrompt(): string {
  return [
    ...
    '   - CHOICE: ambiguous pinyin-like or unclear Chinese meaning; offer candidates',
    '',
    ...
    '- Story-safe: never output private details (names, addresses, emails, phone numbers, IDs). Generalize specifics while preserving meaning; do NOT reduce to intent labels.',
    '',
    'CHOICE candidates:',
    '- Produce 2–3 candidates.',
    '- Candidates MUST be meaning-equivalent to mergedRaw; do not introduce new intent.',
    '- Do NOT output action-taxonomy or intent labels (e.g., "request info", "reject", "confirm").',
    '- If mergedRaw is pinyin/romanized Chinese, FIRST convert to the most plausible Simplified Chinese sentence.',
    '- At least one candidate MUST use intentZh exactly equal to that converted Chinese sentence.',
    '- enMain: natural English that preserves the original meaning.',
    '- intentZh: faithful Chinese paraphrase / meaning, not an abstract intent label.',
    '- enAlternatives: 1–3 alternatives (optional).',
    '- enTemplates: 1–2 templates (optional).',
    '- Example: mergedRaw="woshiyigehaoren" → intentZh="我是一个好人" and enMain="I am a good person".',
    '',
